...
var divElement = document.getElementById('viz1644250838157');                    
var vizElement = divElement.getElementsByTagName('object')[0];                    
if ( divElement.offsetWidth > 800 ) { vizElement.style.width='1504px';vizElement.style.height='745px';} else if ( divElement.offsetWidth > 500 ) { vizElement.style.width='1504px';vizElement.style.height='745px';} else { vizElement.style.width='100%';vizElement.style.height='1027px';}                     
